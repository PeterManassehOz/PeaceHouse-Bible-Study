 ...
 const schema = yup.object().shape({
   ...
   return (
     <div className="min-h-screen flex items-center justify-center bg-white">
       ...
       >
         <h2 className="text-2xl font-semibold text-center text-gray-700 mb-6">Admin Sign Up</h2>
         ...
         <div className="text-center mt-4 text-gray-600">
             Wish to create a Chief Admin? <Link to="/" className="text-green-500">Click Here</Link>
         </div>
       </form>
     </div>
   );
