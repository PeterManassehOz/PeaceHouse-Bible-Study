    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-4 mb-3">
          <div className="w-14 h-14 rounded-2xl bg-green-600 text-white flex items-center justify-center text-3xl shadow-lg">
            <MdMenuBook />
          </div>
      ...
      {studies.length > 0 ? (
              ...
              >
                ...
                <div className="relative h-60 overflow-hidden">
                  ...
                  <div className="absolute bottom-5 left-5 right-5">
                    <span className="inline-block px-4 py-1 rounded-full bg-green-600 text-white text-xs font-semibold mb-3">
                      {study.category}
                    </span>
                ...
                <div className="p-6">
                  ...
                  <div className="bg-blue-50 rounded-2xl p-4 mb-5">
                    <p className="text-xs uppercase tracking-wide text-green-500 mb-2 font-semibold">
                      Study Outline
                    </p>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="flex items-center gap-2 px-5 py-2 rounded-xl bg-green-600 hover:bg-green-700 text-white font-medium transition cursor-pointer">
                      Read Again
                      <MdArrowForward />
                    </button>
                  </div>
        ...
        <div className="max-w-xl mx-auto bg-white border border-gray-100 rounded-[2rem] p-12 text-center shadow-xl">
          <div className="w-28 h-28 rounded-full bg-green-100 mx-auto flex items-center justify-center mb-6">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-green-700 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg transition"
          >
            Browse Studies
          </button>
        </div>
